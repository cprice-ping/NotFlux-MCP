...
export default function AgentPanel({
  ...
  return (
    <aside className="fixed right-0 top-0 bottom-0 z-50 w-full sm:w-[400px] flex flex-col bg-bg-surface border-l border-white/10 shadow-2xl animate-slide-in">
      {/* Header */}
      <header className="flex items-center justify-between px-4 py-3 border-b border-white/10 shrink-0">
        <div className="flex items-center gap-2.5">
          <span className="w-8 h-8 rounded-full bg-gradient-to-br from-ping-blue to-ping-purple flex items-center justify-center text-white">
            <SparkleIcon />
          </span>
          <div>
